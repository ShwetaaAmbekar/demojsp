...
public class CustomerDaoImplementInterface implements ICustomerDao {
	...
	String query = "INSERT INTO customers (FIRSTNAME, LASTNAME,MOBILE_NUMBER,EMAIL_ID) VALUES (?,?,?,?)";
	...
	public Customer updateCustomer(Customer updatedCustomerInfo) {
		...
		String query = "UPDATE customers SET FIRSTNAME=?, LASTNAME=?, MOBILE_NUMBER=?, EMAIL_ID=? WHERE ID=?";
